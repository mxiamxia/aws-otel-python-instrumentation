...
class TestCloudWatchLogClient(unittest.TestCase):
    ...
    def test_event_batch_exceeds_limit_by_count(self):
        ...
        batch["logEvents"] = [{"message": "test"}] * self.log_client.CW_MAX_REQUEST_EVENT_COUNT
    ...
    def test_event_batch_exceeds_limit_by_size(self):
        ...
        batch = self.log_client._create_event_batch()
        batch["byteTotal"] = self.log_client.CW_MAX_REQUEST_PAYLOAD_BYTES - 50
    ...
    def test_append_to_batch(self):
        ...
        self.log_client._append_to_batch(batch, log_event, event_size)
    ...
    def test_flush_pending_events_with_pending_events(self, mock_send_batch):
        ...
        self.log_client._event_batch["logEvents"] = [{"message": "test", "timestamp": int(time.time() * 1000)}]
    ...
    def test_send_log_batch_with_resource_not_found(self):
        ...
        batch = self.log_client._create_event_batch()
        batch["logEvents"] = [{"message": "test message", "timestamp": int(time.time() * 1000)}]
    ...
    def test_is_batch_active_flush_interval_reached(self):
        ...
        batch["createdTimestampMs"] = current_time - (self.log_client.BATCH_FLUSH_INTERVAL + 1000)
        batch["minTimestampMs"] = current_time
        batch["maxTimestampMs"] = current_time
    ...
    def test_send_log_event_batching_logic(self):
        ...
        self.assertEqual(len(self.log_client._event_batch["logEvents"]), 1)
